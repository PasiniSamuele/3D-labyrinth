...
class Character extends Mesh{
	...
	constructor(objStr, offset, worldMatrix, program) {
    ...
    loadLocations(){
		...
		console.log(this.locations['chVertPosition']);
		console.log(this.locations['chTexCoord']);
		console.log(this.locations['chNormal']);
		console.log(this.locations['chProjMatrix']);
		console.log(this.locations['chWorldMatrix']);
    }
    ...
    loadVAO() {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(this.objModel.vertices), gl.STATIC_DRAW);
        ...
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(this.objModel.textures), gl.STATIC_DRAW);
        ...
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(this.objModel.vertexNormals), gl.STATIC_DRAW);
        ...
        gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(this.objModel.indices), gl.STATIC_DRAW);
    }
...
*/
        ...
        gl.drawElements(gl.TRIANGLES, this.objModel.indices.length, gl.UNSIGNED_SHORT, 0);
    }
